...
public class AWSLambdaPublisherTest {
    ...
    public void testHtml() throws Exception {
        LambdaVariables variables = new LambdaVariables(false, "accessKeyId", Secret.fromString("secretKey"), "eu-west-1", "ziplocation", "description", "function", "handler", "1024", "role", "nodejs", "30", true, "full", false, null, false, null, null);
    ...
    public void testPerformFolderSuccess() throws IOException, ExecutionException, InterruptedException {
        LambdaVariables clone = new LambdaVariables(false, "accessKeyId", Secret.fromString("secretKey"), "eu-west-1", "echo", "description", "function", "handler", "1024", "role", "nodejs", "30", true, "full", false, null, false, null, null);
    ...
    public void testPerformZipBuildSuccess() throws IOException, ExecutionException, InterruptedException {
        LambdaVariables clone = new LambdaVariables(false, "accessKeyId", Secret.fromString("secretKey"), "eu-west-1", "echo.zip", "description", "function", "handler", "1024", "role", "nodejs", "30", true, "full", false, null, false, null, null);
    ...
    public void testPerformZipBuildUnstableNotSuccessOnly() throws IOException, ExecutionException, InterruptedException {
        LambdaVariables clone = new LambdaVariables(false, "accessKeyId", Secret.fromString("secretKey"), "eu-west-1", "echo.zip", "description", "function", "handler", "1024", "role", "nodejs", "30", false, "full", false, null, false, null, null);
