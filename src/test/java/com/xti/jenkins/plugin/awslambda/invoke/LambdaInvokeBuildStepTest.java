...
public class LambdaInvokeBuildStepTest {
    ...
    public void testPerform() throws IOException, ExecutionException, InterruptedException {
        ...
        LambdaInvokeBuildStepVariables clone = new LambdaInvokeBuildStepVariables("accessKeyId", Secret.fromString("secretKey"), "eu-west-1", "function", "payload", true, jsonParameterVariables);
