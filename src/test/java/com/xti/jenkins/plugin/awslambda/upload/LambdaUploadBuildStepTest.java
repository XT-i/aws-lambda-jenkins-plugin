...
public class LambdaUploadBuildStepTest {
    ...
    public void testPerformFolderSuccess() throws IOException, ExecutionException, InterruptedException {
        LambdaUploadBuildStepVariables clone = new LambdaUploadBuildStepVariables("accessKeyId", Secret.fromString("secretKey"), "eu-west-1", "echo", "description", "function", "handler", 1024, "role", "nodejs", 30, "full");
    ...
    public void testPerformFolderFailure() throws IOException, ExecutionException, InterruptedException {
        LambdaUploadBuildStepVariables clone = new LambdaUploadBuildStepVariables("accessKeyId", Secret.fromString("secretKey"), "eu-west-1", "echo", "description", "function", null, 1024, "role", "nodejs", 30, "full");
    ...
    public void testPerformZipSuccess() throws IOException, ExecutionException, InterruptedException {
        LambdaUploadBuildStepVariables clone = new LambdaUploadBuildStepVariables("accessKeyId", Secret.fromString("secretKey"), "eu-west-1", "echo.zip", "description", "function", "handler", 1024, "role", "nodejs", 30, "full");
    ...
    public void testPerformZipFailure() throws IOException, ExecutionException, InterruptedException {
        LambdaUploadBuildStepVariables clone = new LambdaUploadBuildStepVariables("accessKeyId", Secret.fromString("secretKey"), "eu-west-1", "echo.zip", "description", "function", "handler", 1024, "role", "c#", 30, "config");
