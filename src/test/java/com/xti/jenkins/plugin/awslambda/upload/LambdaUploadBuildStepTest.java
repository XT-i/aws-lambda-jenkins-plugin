...
public class LambdaUploadBuildStepTest {
    ...
    public void testHtml() throws Exception {
        LambdaUploadBuildStepVariables variables = new LambdaUploadBuildStepVariables(false, "accessKeyId", Secret.fromString("secretKey"), "eu-west-1", "ziplocation", "description", "function", "handler", "1024", "role", "nodejs", "30", "full", false);
    ...
    public void testPerformFolderSuccess() throws IOException, ExecutionException, InterruptedException {
        LambdaUploadBuildStepVariables clone = new LambdaUploadBuildStepVariables(false, "accessKeyId", Secret.fromString("secretKey"), "eu-west-1", "echo", "description", "function", "handler", "1024", "role", "nodejs", "30", "full", false);
    ...
    public void testPerformFolderFailure() throws IOException, ExecutionException, InterruptedException {
        LambdaUploadBuildStepVariables clone = new LambdaUploadBuildStepVariables(false, "accessKeyId", Secret.fromString("secretKey"), "eu-west-1", "echo", "description", "function", null, "1024", "role", "nodejs", "30", "full", false);
    ...
    public void testPerformZipSuccess() throws IOException, ExecutionException, InterruptedException {
        LambdaUploadBuildStepVariables clone = new LambdaUploadBuildStepVariables(false, "accessKeyId", Secret.fromString("secretKey"), "eu-west-1", "echo.zip", "description", "function", "handler", "1024", "role", "nodejs", "30", "full", false);
    ...
    public void testPerformZipFailure() throws IOException, ExecutionException, InterruptedException {
        LambdaUploadBuildStepVariables clone = new LambdaUploadBuildStepVariables(false, "accessKeyId", Secret.fromString("secretKey"), "eu-west-1", "echo.zip", "description", "function", "handler", "1024", "role", "c#", "30", "config", false);
